...
public abstract class BasePreference<T> {
    ...
    public void set(T value) {
        ...
        if (BuildConfig.DEBUG) {
            Log.v("BasePreference", "set " + name + " to " + value);
        }
    }
    ...
    public T get() {
        ...
        if (BuildConfig.DEBUG) {
            Log.v("BasePreference", "get " + name + " as " + value);
        }
        return value;
    }
    ...
    public T get(T defaultValue) {
        final String name = this.getPreferenceName();
        return this.acquire(mPreferences, name, defaultValue);
    }
    ...
    /**
     * Perform the actual updating. Do not {@link SharedPreferences.Editor#commit()} or {@link
